      ...
      <nav ref={navRef} className="min-w-screen relative z-50">
        <div className="w-full flex flex-wrap items-center justify-between mx-auto px-2 md:px-6 p-4 md:p-6">
          ...
          <div className="flex md:order-2 gap-4">
            <button id='theme-toggle' type='button' aria-label="dark-mode-toggle" className='text-slate-700 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg text-sm p-2'>
            ...
            <button href='https://dashboard.inheritly.app' type="button" aria-label="launch-app" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 hidden md:inline-block">Dashboard</button>
            <button href='https://dashboard.inheritly.app' type="button" aria-label="launch-app" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 text-center md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 md:hidden">
