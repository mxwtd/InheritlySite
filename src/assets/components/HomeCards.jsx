        ...
        <div className="px-4 mx-auto max-w-screen-xl">
          ...
          <motion.div
            ...
            >
              ...
              <h1 className="text-slate-900 dark:text-white text-2xl md:text-5xl font-extrabold mb-3">Your family assets, visualised.</h1>
              <p className="text-sm md:text-lg font-normal text-slate-500 dark:text-slate-400 mb-6">Our fintech app empowers you to effortlessly manage your family estate. Gain full control over your assets, streamline planning, and make informed decisions. Unlock financial opportunities, collaborate with ease, and secure a prosperous future. Simplify wealth management and embrace the future of estate planning with our intuitive platform.</p>
              <a href="#" className="inline-flex justify-center items-center py-2.5 px-5 text-sm md:text-lg font-medium text-center text-white rounded-2xl bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                Explore Features
          ...
          <div className="grid h-full md:grid-cols-2 gap-8">
            ...
            >
              ...
              <h2 className="text-slate-900 dark:text-white text-2xl font-extrabold mb-3">Effortless Will creation with AI.</h2>
              <p className="text-sm md:text-lg font-normal text-slate-500 dark:text-slate-400 mb-4">Our app features an AI-powered will generator for seamless estate planning. Say goodbye to complex paperwork and hello to a simplified process. Experience the convenience of creating a comprehensive will with ease, backed by intelligent algorithms. Secure the future of your estate effortlessly and efficiently.</p>
              <a href="#" className="text-blue-600 dark:text-blue-500 hover:underline font-medium text-sm md:text-lg inline-flex items-center">Try the Will Generator
            ...
            >
              ...
              <h2 className="text-slate-900 dark:text-white text-2xl font-extrabold mb-3">Family-Friendly Simplicity</h2>
              ...
              <a href="#" className="text-blue-600 dark:text-blue-500 hover:underline font-medium text-sm md:text-lg inline-flex items-center">Try it Free
                <svg aria-hidden="true" className="w-4 h-4 ml-2" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                </svg>
              </a>
