        ...
        <div className="px-4 mx-auto max-w-screen-xl">
          ...
          >
            <div>
              ...
              <p className="mb-3 text-slate-500 dark:text-slate-400">A wide array of features to help you track and view your family assets globally.</p>
              <div className='grid grid-cols-2 lg:grid-cols-4 justify-items-center md:px-20 pt-5'>
                <div className='flex flex-col justify-center items-center gap-3 mb-4'>
                  ...
                  <h2 className="text-center text-slate-500 dark:text-slate-400">Easy For the family</h2>
                </div>
                <div className='flex flex-col justify-center items-center gap-3 mb-4'>
                  <svg fill="none" className='w-20 h-20 text-slate-500 dark:text-slate-400' stroke="currentColor" strokeWidth={1} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  ...
                  <h2 className="text-center text-slate-500 dark:text-slate-400">Track all your Assets</h2>
                </div>
                <div className='flex flex-col justify-center items-center gap-3 mb-4'>
                  <svg fill="none" className='w-20 h-20 text-slate-500 dark:text-slate-400' stroke="currentColor" strokeWidth={1} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />
                  </svg>
                  <h2 className="text-center text-slate-500 dark:text-slate-400">Multi-device support</h2>
                </div>
                <div className='flex flex-col justify-center items-center gap-3 mb-4'>
                  <svg fill="none" className='w-20 h-20 text-slate-500 dark:text-slate-400' stroke="currentColor" strokeWidth={1} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
