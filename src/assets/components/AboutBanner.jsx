        ...
        <div className="grid md:grid-cols-3 gap-4 w-full max-w-screen-xl grid-cols-1">
          ...
          >
            <div className='flex flex-col justify-start items-left h-full'>
              ...
              <p className=" text-lg font-normal text-slate-500 lg:text-xl dark:text-slate-200">To revolutionise family estate wealth management, empowering families to secure their financial legacies with confidence, while providing a seamless user experience.</p>
            </div>
          </motion.div>
          <motion.div
          ...
          >
            <div>
              ...
              <p className="mb-8 text-lg font-normal text-slate-500 lg:text-xl dark:text-slate-200">At Inheritly, our mission is to empower families to confidently navigate and manage their wealth, ensuring a lasting legacy for future generations. We strive to simplify the complexities of estate management through our innovative app, providing accessible tools and resources that promote transparency, collaboration, and informed decision-making. By leveraging technology and fostering a user-centric approach, we aim to revolutionise the way families preserve and grow their financial assets.</p>
            </div>
          </motion.div>
        </div>
      </div>
