        ...
        <div className="grid md:grid-cols-3 lg:gap-4 w-full max-w-screen-xl grid-cols-1">
          ...
          >
            <div>
              ...
              <p className=" text-sm md:text-lg font-normal text-slate-500 dark:text-slate-200">At Inheritly, our mission is to empower families to confidently navigate and manage their wealth, ensuring a lasting legacy for future generations. We strive to simplify the complexities of estate management through our innovative app, providing accessible tools and resources that promote transparency, collaboration, and informed decision-making. By leveraging technology and fostering a user-centric approach, we aim to revolutionise the way families preserve and grow their financial assets.</p>
            </div>
          </motion.div>
        </div>
      </div>
